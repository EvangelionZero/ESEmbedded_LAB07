...
int main(void)
{
	...
	//RCC Enable SYSCFG
	SET_BIT(RCC_BASE + RCC_PLLCFGR_OFFSET, SYSCFGEN_BIT);
	...
	//EXTI Configurations
	//1.IMR
	SET_BIT(EXTI_BASE + EXTI_IMR_OFFSET, EXTI_MR(0));
	//2.RTSR
	SET_BIT(EXTI_BASE + EXTI_RTSR_OFFSET, EXTI_TR(0));
	//3.FRSR
	CLEAR_BIT(EXTI_BASE + EXTI_FTSR_OFFSET, EXTI_TR(0));
	//4.PR
	SET_BIT(EXTI_BASE + EXTI_PR_OFFSET, EXTI_PR(0));
